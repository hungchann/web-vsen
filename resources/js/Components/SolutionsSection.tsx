    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{__('Precision Medicine Across the Pathway')}</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              {__('Our clinical and therapeutic solutions help transform the way clinicians approach patient care, from screening to follow-up.')}
            </p>
         </div>
            ...
            {SOLUTIONS.map((sol) => (
              <div key={sol.id} className="relative overflow-hidden rounded-xl h-[400px] group shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">{__(sol.title)}</h3>
