        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-10 flex justify-end items-center gap-6">
            ...
            <div className="relative">
                <input 
                    ...
                    className="w-40 bg-white pl-8 pr-3 py-1 border border-gray-300 rounded-full text-xs focus:outline-none focus:border-ge-blue focus:ring-1 focus:ring-ge-blue transition-all"
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    onKeyDown={handleSearch}
                />
                <svg className="w-3 h-3 text-gray-400 absolute left-2.5 top-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
