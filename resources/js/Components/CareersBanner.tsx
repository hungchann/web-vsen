  ...
  return (
    <section className="bg-ge-blue py-16 text-white text-center">
      <div className="max-w-3xl mx-auto px-4">
         <h2 className="text-3xl font-bold mb-6 italic">Building a world that works.</h2>
         <p className="text-blue-100 mb-8 text-lg">
           Join our team of experts working to solve the healthcare industry's toughest challenges.
         </p>
