      ...
      <div className="bg-white">
        <div className="bg-gray-50 py-16 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Education & Training</h1>
            <p className="text-lg text-gray-600 max-w-2xl">
              Empowering healthcare professionals with the knowledge and skills to improve patient outcomes.
            </p>
          </div>
        </div>
            ...
            {programs.map((program, index) => (
              <div key={index} className="flex flex-col bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm">
                <div className="h-48 bg-ge-blue/5 flex items-center justify-center">
                  <span className="text-ge-blue font-bold text-center px-4">{program.title}</span>
                </div>
                <div className="p-6 flex-1 flex flex-col">
                  <span className="text-[10px] uppercase font-bold text-ge-blue tracking-widest mb-2 block">{program.category}</span>
